...
const InformeBoleta = (boleta, codigo="CJ01") => {
  ...
  informe.setFont("arial");
  informe.setFontType("bold");
  informe.setFontSize(16);
  informe.text("Constancia de Materiales", 15, 7,'center');
  informe.setFontType("bold");
  informe.setFontSize(14);
  informe.text('CODIGO', 5, 14);
  informe.setFontType("normal");
  informe.setFontSize(13);
  informe.text(codigo, 5, 17);
  informe.setFontType("bold");
  informe.setFontSize(14);
  informe.text('ENCARGADO', 50, 14);
  informe.setFontType("normal");
  informe.setFontSize(13);
  informe.text(boleta.encargado.trim(), 50, 17);
...
const CrearBoleta = async () => {
  try {
    ...
    if (request.ok) {
      ...
      let menssage_error = "Ocurrio un error desconocido al crear la solicitud";
      if (isJSON(data)) {
